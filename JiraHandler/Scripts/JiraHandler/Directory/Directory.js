var host = "/jirahandler";// http://10.10.30.190:81
...
(function () {
    ...
    this.getOperations = function (projectKey) {
        ...
        $.ajax({
            url: host + "/Directory/SetDefaultKey",
            method: "post",
            data: { "Key": projectKey },
            cache: false
        }).done(function (data) {
    ...
    this.getCreateIssue = function () {
        $.ajax({
            url: host + "/Directory/CreateSubTaskPage",
            method: "Get",
            cache: false
        }).done(function (data) {
            $(".body-content").html(data);
    ...
    this.insertCreateSubtaskTemplate = function () {
        ...
        $.ajax({
            url: host + "/Directory/GetCreateFormTemplate",
            method: "Get",
            cache: false
        }).done(function (data) {
    ...
    this.getInfo = function () {
        ...
        if (val) {
            $.ajax({
                url: host + "/Directory/GetIssue?issueNumber=" + val,
                method: "Get",
                cache: false,
                dataType: 'json',
            }).done(function (data) {
    ...
    this.submitForm = function () {
        ...
        $.ajax({
            url: host + "/Directory/CreateSubtast",
            method: "Post",
